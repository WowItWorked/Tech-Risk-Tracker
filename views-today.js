    ...
    <aside style="flex: 1 1 280px; max-width: 460px; min-width: 0;">
      ...
      <div style="border-top: 2px solid #14171A; padding-top: 10px;">
        ...
        <div style="margin-top: 8px; font-family: 'Public Sans', system-ui, sans-serif; font-size: 12.5px; line-height: 1.5; color: #4D555C;">
          <button onClick=${v.pubGoDaily} title="Open today’s brief" class="hv-soft" style="display: flex; justify-content: space-between; align-items: baseline; gap: 12px; width: 100%; padding: 6px 0; border-bottom: 1px solid #E9EBED;"><span style="color: #0069AA; white-space: nowrap;">Next edition →</span><span style="font-variant-numeric: tabular-nums; color: #6B747C; font-size: 11.5px; text-align: right;">Hourly · 6 AM–6 PM ET Weekdays</span></button>
